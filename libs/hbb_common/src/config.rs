...
lazy_static::lazy_static! {
    ...
    pub static ref APP_NAME: RwLock<String> = RwLock::new("Rapha Assist".to_owned());
...
// Custom client (grand-père) : serveur hbbs/hbbr auto-hébergé, clé publique du serveur.
pub const RENDEZVOUS_SERVERS: &[&str] = &["92.88.15.36"];
pub const RS_PUB_KEY: &str = "ir5ijFWw5G2hxnmBK35v0ArlfKHmEo1HsbDhQQ3XELw=";
